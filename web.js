  ...
  t.fn &&
    ...
    (function (t, e, r) {
      ...
      try {
        ...
        return (
          t.pure &&
            ((t.state = d), t.owned && t.owned.forEach(q), (t.owned = null)),
          (t.updatedAt = r + 1),
          D(e)
        );
      }
...
function M(t) {
  for (let r = 0; r < t.observers.length; r += 1) {
    var e = t.observers[r];
    e.state || ((e.state = f), (e.pure ? v : w).push(e), e.observers && M(e));
  }
}
function q(t) {
  let e;
    ...
    return new Proxy(
      {
        ...
        has(e) {
          for (let r = t.length - 1; 0 <= r; r--) if (e in V(t[r])) return !0;
          return !1;
        },
        keys() {
          var e = [];
          for (let r = 0; r < t.length; r++) e.push(...Object.keys(V(t[r])));
          return [...new Set(e)];
        },
      },
      U
            ...
            E(() => {
              ...
              if (0 === v)
                ...
                for (
                  ...
                  (h[y] = n[b]), (d[y] = o[b]), a && (f[y] = a[b]);
                for (t = new Map(), e = new Array(y + 1), c = y; c >= g; c--)
                  (m = u[c]),
                    (l = t.get(m)),
                    (e[c] = void 0 === l ? -1 : l),
                    t.set(m, c);
...
function J(t) {
  const e = t.keyed,
    r = A(() => t.when, void 0, { equals: (t, r) => (e ? t === r : !t == !r) });
  return A(
    () => {
      const s = r();
      if (s) {
  ...
  return "style" === e
    ...
    ? (function (t, e, r = {}) {
        ...
        for (o = 0, i = n.length; o < i; o++) {
          var a = n[o];
          a && "undefined" !== a && !e[a] && (pt(t, a, !1), delete r[a]);
        }
    ...
    if (a instanceof Node) t.push(a);
      ...
      if (Array.isArray(a)) n = bt(t, a, l) || n;
        ...
        if (s) {
          ...
          n =
            bt(t, Array.isArray(a) ? a : [a], Array.isArray(l) ? l : [l]) || n;
        } else t.push(a), (n = !0);
      else {
        var o = String(a);
        l && 3 === l.nodeType
...
const St = (t) => null == t,
  ...
  Tt =
    ...
    ({ chatflowid: t, apiHost: e = "http://localhost:3000", body: r }) =>
      Et({ method: "POST", url: e + "/api/v1/prediction/" + t, body: r })),
  Bt = ot(
  ...
  getTokens(t, e, r) {
    ...
    t: for (; n; )
      if (
        ...
        (n = n.substring(s[0].length)), this.tokens.push({ type: kt.hr });
        ...
        var l,
          c = s[2],
          h =
            (this.tokens.push({ type: kt.listStart, ordered: 1 < c.length }),
...
const ce = ot(
  ...
  ve =
    (it(["click"]),
    ot(
      '<span> target="_blank" rel="noopener noreferrer" class="lite-badge" id="lite-badge"><span>'
    )),
  we = "#303235",
  xe = (t) => {
    let e, r;
      ...
      });
    {
      ...
      return (
        ...
        C({ _v$: void 0, _v$2: void 0, _v$3: void 0 }),
        r
      );
    }
  },
...
class or extends Ne {
  ...
  create() {
    ...
    "undefined" != typeof document &&
      ((this.index = or.requestsCount++), (or.requests[this.index] = this));
  }
  onError(t) {
...
function xr(t, e) {
  if (t && "object" == typeof t)
    if (Array.isArray(t)) {
      ...
      for (const e in t)
        if (Object.prototype.hasOwnProperty.call(t, e) && xr(t[e])) return !0;
    }
  return !1;
}
function kr(t) {
  var e = [],
    r = t.data;
  return (
    (t.data = _r(r, e)), (t.attachments = e.length), { packet: t, buffers: e }
  );
}
function _r(t, e) {
  if (!t) return t;
...
function Sr(t, e) {
  if (t) {
    ...
    if (Array.isArray(t)) for (let r = 0; r < t.length; r++) t[r] = Sr(t[r], e);
...
class Or extends Ne {
  ...
  decodeString(t) {
    ...
    if (void 0 === _t[r.type]) throw new Error("unknown packet type " + r.type);
  ...
  emit(t, ...e) {
    ...
    return (
      ...
      !this._opts.retries || this.flags.fromQueue || this.flags.volatile
        ? (((t = { type: _t.EVENT, data: e, options: {} }).options.compress =
...
const Dr = (t) => {
  ...
  Ur = (t) => {
    ...
    const [n, o] = _(""),
      ...
      [l, c] = _(!1),
      [h, u] = _({}),
      [p, d] = _([{ message: t.welcomeMessage ?? Wr, type: "apiMessage" }], {
        equals: !1,
      }),
      [f, g] = _(""),
      [b, y] = _(!1),
        ...
        S(async () => {
          ...
          return (
            ...
            () => {
              o(""),
                a(!1),
                d([{ message: t.welcomeMessage ?? Wr, type: "apiMessage" }]),
                r && (r.disconnect(), g(""));
            }
          );
        }),
    ...
    return [
      (() => {
        ...
        return (
          "function" ==
          typeof (h = ("function" == typeof (h = s) ? ht(h, o) : (s = o), e))
            ? ht(h, l)
            : (e = l),
  ...
  Vr = (t) => {
    return (
      (e = Hr()), "function" == typeof (r = t.ref) ? ht(r, e) : (t.ref = e), e
    );
    var e, r;
  },
  Yr = ot("<style>"),
